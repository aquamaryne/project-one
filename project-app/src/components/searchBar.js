...
function SearchBar({ onSearch }){
    ...
    return(
        <form onSubmit={hanldeSubmit} className='flex items-center'>
            ...
            />
            <button type='submit' className='px-4 py-2 ml-4 text-white bg-blue-500 rounded-md hover:bg-blue-600 focus:outline-none focus:ring-2 focus:ring-blue-500'> Search </button>
